...
router.route("/getPendingEmployers").post((req,res)=>{
    Employee.find({status:"0",branch:req.body.branch}).then((employees)=>{
        res.json(employees)
    }).catch((err)=>{
        console.log(err);
    })
...
console.log(req.body.branch)
    Employee.find({status:"2",branch:req.body.branch}).then((employees)=>{
        res.json(employees)
    }).catch((err)=>{
        console.log(err);
    })
...
router.route("/getEnrolledEmployers").post((req,res)=>{
    ...
    Employee.find({status:"1",branch:req.body.branch}).then((employees)=>{
        res.json(employees)
    }).catch((err)=>{
        console.log(err);
    })
