          ...
          <div className={classes.productRight}>
            <div className={classes.productData}>
              ...
              <div className={classes.productInfo}>
                ...
                {(inputPrice) ? (<ProductEdit title="Product Name" value={product.price} edit={false} OnEditProduct={setPriceHandler}></ProductEdit>) : 
                (<ProductDetails title="Price per 1 kg" value={`Rs. ${product.price}.00`} edit={true}  onEdit={inputPriceEditHandler}></ProductDetails>)}

                {(inputQuantity) ? (<ProductEdit title="Product Name" value={product.quantity} edit={false} OnEditProduct={setQuantityHandler}></ProductEdit>) : 
