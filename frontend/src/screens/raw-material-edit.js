...
export default function Home(props) {
    ...
    function updateData(id) {
            ...
            editRawMaterial({  _id:id,name: name, itemCode: rawMaterialData.itemCode, quantity: quantity,unitPrice:unitPrice }).then((result) => {
            if (result.status) {
                swal({           
                    title: "Success!",
                    ...
                    <form>
                        ...
                        <center><h2>Edit Raw Material</h2></center>
                            ...
                            <input type="text" class="form-control" id="itemCode" value={itemCode} readOnly placeholder={rawMaterialData.itemCode}
                                ...
                                <input type="text" class="form-control" id="name" value={name} placeholder={rawMaterialData.name} 
                                    onChange={(e) => {
                            ...
                            <input type="text" class="form-control" id="unitPrice"  value={unitPrice} placeholder={rawMaterialData.unitPrice} 
                                onChange={(e) => {
                            ...
                            <input type="text" class="form-control" id="qusntity"  value={quantity} placeholder={rawMaterialData.quantity} 
                                onChange={(e) => {
