...
import { deleteRawMaterial } from '../controllers/raw-material';
...
export default function Manage() {
    ...
    useEffect(() => {
        function getRawMaterials() {
            axios.get("http://localhost:8090/raw-material/getAllRawMaterials").then((res) => {
                                    ...
                                    {raw_materials.map((RawMaterial) => {
                                        return (
                                            <tr>
                                                ...
                                                <Link to={"/raw-material-update/"+RawMaterial._id} class=""><button class="btn btn-warning" >Edit</button></Link>
